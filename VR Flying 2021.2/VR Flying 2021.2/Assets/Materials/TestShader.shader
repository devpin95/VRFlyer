...
Shader "TestShader"
{
	Properties
	{
		_GrassAntiTiling3("Grass Anti Tiling 3", Float) = 0.2
		_GrassAntiTiling2("Grass Anti Tiling 2", Float) = 0.02
		_GrassAntiTiling1("Grass Anti Tiling 1", Float) = 0.002
	...
	SubShader
	{
		...
		uniform float _GrassAntiTiling1;
		uniform float _GrassAntiTiling2;
		uniform float _GrassAntiTiling3;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_cast_0 = (_GrassAntiTiling1).xx;
			float2 uv_TexCoord9_g5 = i.uv_texcoord * temp_cast_0;
			float2 temp_cast_1 = (_GrassAntiTiling2).xx;
			float2 uv_TexCoord11_g5 = i.uv_texcoord * temp_cast_1;
			float2 temp_cast_2 = (_GrassAntiTiling3).xx;
			float2 uv_TexCoord13_g5 = i.uv_texcoord * temp_cast_2;
			float3 temp_cast_3 = (( ( ( tex2D( _AntiTilingTexture, uv_TexCoord9_g5 ).g + 0.0 ) * ( tex2D( _AntiTilingTexture, uv_TexCoord11_g5 ).g + 0.0 ) ) * ( tex2D( _AntiTilingTexture, uv_TexCoord13_g5 ).g + 0.0 ) )).xxx;
			float3 lerpResult21_g5 = lerp( _AntiTilingVector , temp_cast_3 , float3( 1,1,1 ));
			...
			float2 temp_cast_7 = (_Grass1tile).xx;
			float2 uv_TexCoord54 = i.uv_texcoord * temp_cast_7;
			float4 color92 = IsGammaSpace() ? float4(0.4138842,1,0,1) : float4(0.1428077,1,0,1);
			float3 temp_output_7_0_g2 = float3(0,1,0);
			...
			float4 lerpResult86 = lerp( ( float4( GrassColorVariation60 , 0.0 ) * tex2D( _Rock, uv_TexCoord88 ) ) , ( ( float4( GrassColorVariation60 , 0.0 ) * tex2D( _Grass1, uv_TexCoord54 ) ) * color92 ) , Slope82);
			float2 temp_cast_8 = (_ArialTreeTile).xx;
			float2 uv_TexCoord103 = i.uv_texcoord * temp_cast_8;
...
/*ASEBEGIN
Version=18933
294;73;2400;921;1570.004;15.82288;1.3;True;True
Node;AmplifyShaderEditor.CommentaryNode;61;-912,-1024;Inherit;False;802;351;Anti Tiling;4;57;60;58;59;Color Variation;0.0003061295,0,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;59;-864,-784;Inherit;False;Property;_GrassAntiTiling3;Grass Anti Tiling 3;0;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;-864,-960;Inherit;False;Property;_GrassAntiTiling1;Grass Anti Tiling 1;2;0;Create;True;0;0;0;False;0;False;0.002;0.002;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;58;-864,-880;Inherit;False;Property;_GrassAntiTiling2;Grass Anti Tiling 2;1;0;Create;True;0;0;0;False;0;False;0.02;0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;-1178,172.1;Inherit;False;Property;_Grass1tile;Grass 1 tile;3;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;129;-640,-928;Inherit;False;Anti Tiling;18;;5;7a9ec6dda0cb2dd47af47567be7687ed;0;3;8;FLOAT;0.002;False;10;FLOAT;0.02;False;12;FLOAT;0.2;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;80;-32,-896;Inherit;False;Property;_SlopeMax;Slope Max;4;0;Create;True;0;0;0;False;0;False;1;-1.39;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-1147.6,572.1002;Inherit;False;Property;_Rock1tile;Rock 1 tile;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-32,-976;Inherit;False;Property;_SlopeMin;Slope Min;5;0;Create;True;0;0;0;False;0;False;-1;2.88;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;51;-793.9999,44.1;Inherit;True;Property;_Grass1;Grass 1;8;0;Create;True;0;0;0;False;0;False;-1;7b4b44557efd3ef4190530e2e45001bf;7b4b44557efd3ef4190530e2e45001bf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;104;-914.6414,845.9297;Inherit;False;Property;_ArialTreeTile;Arial Tree Tile;13;0;Create;True;0;0;0;False;0;False;0;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;89;-779.5999,572.1002;Inherit;True;Property;_Rock;Rock;7;0;Create;True;0;0;0;False;0;False;-1;da8cece31ebe275419c6fe089590f85b;da8cece31ebe275419c6fe089590f85b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;91;-683.5999,492.1001;Inherit;False;60;GrassColorVariation;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;102;-446.5637,811.3072;Inherit;True;Property;_ArialTreeTexture;Arial Tree Texture;12;0;Create;True;0;0;0;False;0;False;-1;None;dcf272e1bc54fbc40b28241c4560048a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;124;-912,-1392;Inherit;False;824.9999;342.0002;Tree Anti Tiling;4;122;123;120;119;Color Variation;0,0,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;133;657.3,-897.3;Inherit;False;Property;_HeightMapTile;Height Map Tile;21;0;Create;True;0;0;0;False;0;False;1;0.0001;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;130;-640,-1312;Inherit;False;Anti Tiling;18;;6;7a9ec6dda0cb2dd47af47567be7687ed;0;3;8;FLOAT;0.002;False;10;FLOAT;0.02;False;12;FLOAT;0.2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;123;-864,-1344;Inherit;False;Property;_TreeAntiTiling1;Tree Anti Tiling 1;17;0;Create;True;0;0;0;False;0;False;0.002;0.002;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;99;992,-896;Inherit;True;Property;_HeightMap;HeightMap;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;134;1536,-897;Inherit;False;Property;_AltitudeMapTile;Altitude Map Tile;22;0;Create;True;0;0;0;False;0;False;1;0.0001;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;119;-864,-1168;Inherit;False;Property;_TreeAntiTiling3;Tree Anti Tiling 3;15;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;120;-864,-1264;Inherit;False;Property;_TreeAntiTiling2;Tree Anti Tiling 2;16;0;Create;True;0;0;0;False;0;False;0.02;0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-1098.001,284.1;Inherit;False;Property;_GrassNormalScale;Grass Normal Scale;9;0;Create;True;0;0;0;False;0;False;10;10;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;105;1920,-897;Inherit;True;Property;_AltitudeMap;AltitudeMap;14;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;52;-793.9999,236.1;Inherit;True;Property;_Grass1normal;Grass 1 normal;10;0;Create;True;0;0;0;False;0;False;-1;52979744929b5af42a3f726bd4dc72b2;52979744929b5af42a3f726bd4dc72b2;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;122;-336,-1280;Inherit;False;TreeColorVariation;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;129;8;57;0
WireConnection;129;10;58;0
WireConnection;129;12;59;0
...
WireConnection;130;8;123;0
WireConnection;130;10;120;0
WireConnection;130;12;119;0
...
ASEEND*/
//CHKSM=5C9323793EABCE590151595B75E3DBAB3C2881F8