...
Shader "TestShader"
{
	Properties
	{
		...
		[ASEBegin]_Grass1tile("Grass 1 tile", Float) = 2
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 _AntiTilingVector;
			float3 _RockAntiTiling;
			float3 _GrassAntiTiling;
			float _Rock1tile;
			float _Grass1tile;
			float _SlopeMin;
			float _SlopeMax;
			float _ArialTreeTile;
			float _Smoothness;
			...
			#endif
			CBUFFER_END
			sampler2D _AntiTilingTexture;
			sampler2D _Rock;
			sampler2D _Grass1;
			sampler2D _ArialTreeTexture;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord9_g8 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_RockAntiTiling.y).xx;
				float2 texCoord11_g8 = IN.ase_texcoord8.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_RockAntiTiling.z).xx;
				float2 texCoord13_g8 = IN.ase_texcoord8.xy * temp_cast_2 + float2( 0,0 );
				float3 temp_cast_3 = (( ( ( tex2D( _AntiTilingTexture, texCoord9_g8 ).g + 0.0 ) * ( tex2D( _AntiTilingTexture, texCoord11_g8 ).g + 0.0 ) ) * ( tex2D( _AntiTilingTexture, texCoord13_g8 ).g + 0.0 ) )).xxx;
				...
				float2 texCoord88 = IN.ase_texcoord8.xy * temp_cast_5 + float2( 0,0 );
				float2 temp_cast_6 = (_GrassAntiTiling.x).xx;
				float2 texCoord9_g5 = IN.ase_texcoord8.xy * temp_cast_6 + float2( 0,0 );
				float2 temp_cast_7 = (_GrassAntiTiling.y).xx;
				float2 texCoord11_g5 = IN.ase_texcoord8.xy * temp_cast_7 + float2( 0,0 );
				float2 temp_cast_8 = (_GrassAntiTiling.z).xx;
				float2 texCoord13_g5 = IN.ase_texcoord8.xy * temp_cast_8 + float2( 0,0 );
				float3 temp_cast_9 = (( ( ( tex2D( _AntiTilingTexture, texCoord9_g5 ).g + 0.0 ) * ( tex2D( _AntiTilingTexture, texCoord11_g5 ).g + 0.0 ) ) * ( tex2D( _AntiTilingTexture, texCoord13_g5 ).g + 0.0 ) )).xxx;
				...
				float2 texCoord54 = IN.ase_texcoord8.xy * temp_cast_11 + float2( 0,0 );
				float4 color92 = IsGammaSpace() ? float4(0.4138842,1,0,1) : float4(0.1428077,1,0,1);
				float3 temp_output_7_0_g9 = float3(0,1,0);
				...
				float3 tangentToWorldDir1_g9 = ASESafeNormalize( mul( ase_tangentToWorldFast, temp_output_7_0_g9 ) );
				float dotResult2_g9 = dot( tangentToWorldDir1_g9 , temp_output_7_0_g9 );
				float lerpResult4_g9 = lerp( _SlopeMin , _SlopeMax , abs( dotResult2_g9 ));
				float Slope82 = saturate( lerpResult4_g9 );
				float4 lerpResult86 = lerp( ( float4( RockColorVariation157 , 0.0 ) * tex2D( _Rock, texCoord88 ) ) , ( ( float4( GrassColorVariation60 , 0.0 ) * tex2D( _Grass1, texCoord54 ) ) * color92 ) , Slope82);
				float2 temp_cast_12 = (_ArialTreeTile).xx;
				float2 texCoord103 = IN.ase_texcoord8.xy * temp_cast_12 + float2( 0,0 );
				float4 tex2DNode102 = tex2D( _ArialTreeTexture, texCoord103 );
				float4 lerpResult113 = lerp( lerpResult86 , tex2DNode102 , float4( 0,0,0,0 ));
				
				float3 Albedo = lerpResult113.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_RockAntiTiling.x).xx;
				float2 texCoord9_g8 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_RockAntiTiling.y).xx;
				float2 texCoord11_g8 = IN.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_RockAntiTiling.z).xx;
				float2 texCoord13_g8 = IN.ase_texcoord4.xy * temp_cast_2 + float2( 0,0 );
				float3 temp_cast_3 = (( ( ( tex2D( _AntiTilingTexture, texCoord9_g8 ).g + 0.0 ) * ( tex2D( _AntiTilingTexture, texCoord11_g8 ).g + 0.0 ) ) * ( tex2D( _AntiTilingTexture, texCoord13_g8 ).g + 0.0 ) )).xxx;
				float3 lerpResult21_g8 = lerp( _AntiTilingVector , temp_cast_3 , float3( 1,1,1 ));
				float3 RockColorVariation157 = lerpResult21_g8;
				float2 temp_cast_5 = (_Rock1tile).xx;
				float2 texCoord88 = IN.ase_texcoord4.xy * temp_cast_5 + float2( 0,0 );
				float2 temp_cast_6 = (_GrassAntiTiling.x).xx;
				float2 texCoord9_g5 = IN.ase_texcoord4.xy * temp_cast_6 + float2( 0,0 );
				float2 temp_cast_7 = (_GrassAntiTiling.y).xx;
				float2 texCoord11_g5 = IN.ase_texcoord4.xy * temp_cast_7 + float2( 0,0 );
				float2 temp_cast_8 = (_GrassAntiTiling.z).xx;
				float2 texCoord13_g5 = IN.ase_texcoord4.xy * temp_cast_8 + float2( 0,0 );
				float3 temp_cast_9 = (( ( ( tex2D( _AntiTilingTexture, texCoord9_g5 ).g + 0.0 ) * ( tex2D( _AntiTilingTexture, texCoord11_g5 ).g + 0.0 ) ) * ( tex2D( _AntiTilingTexture, texCoord13_g5 ).g + 0.0 ) )).xxx;
				float3 lerpResult21_g5 = lerp( _AntiTilingVector , temp_cast_9 , float3( 1,1,1 ));
				float3 GrassColorVariation60 = lerpResult21_g5;
				float2 temp_cast_11 = (_Grass1tile).xx;
				float2 texCoord54 = IN.ase_texcoord4.xy * temp_cast_11 + float2( 0,0 );
				float4 color92 = IsGammaSpace() ? float4(0.4138842,1,0,1) : float4(0.1428077,1,0,1);
				float3 temp_output_7_0_g9 = float3(0,1,0);
				...
				float4 lerpResult86 = lerp( ( float4( RockColorVariation157 , 0.0 ) * tex2D( _Rock, texCoord88 ) ) , ( ( float4( GrassColorVariation60 , 0.0 ) * tex2D( _Grass1, texCoord54 ) ) * color92 ) , Slope82);
				float2 temp_cast_12 = (_ArialTreeTile).xx;
				float2 texCoord103 = IN.ase_texcoord4.xy * temp_cast_12 + float2( 0,0 );
				float4 tex2DNode102 = tex2D( _ArialTreeTexture, texCoord103 );
				float4 lerpResult113 = lerp( lerpResult86 , tex2DNode102 , float4( 0,0,0,0 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_RockAntiTiling.x).xx;
				float2 texCoord9_g8 = IN.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (_RockAntiTiling.y).xx;
				float2 texCoord11_g8 = IN.ase_texcoord2.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (_RockAntiTiling.z).xx;
				float2 texCoord13_g8 = IN.ase_texcoord2.xy * temp_cast_2 + float2( 0,0 );
				float3 temp_cast_3 = (( ( ( tex2D( _AntiTilingTexture, texCoord9_g8 ).g + 0.0 ) * ( tex2D( _AntiTilingTexture, texCoord11_g8 ).g + 0.0 ) ) * ( tex2D( _AntiTilingTexture, texCoord13_g8 ).g + 0.0 ) )).xxx;
				float3 lerpResult21_g8 = lerp( _AntiTilingVector , temp_cast_3 , float3( 1,1,1 ));
				float3 RockColorVariation157 = lerpResult21_g8;
				float2 temp_cast_5 = (_Rock1tile).xx;
				float2 texCoord88 = IN.ase_texcoord2.xy * temp_cast_5 + float2( 0,0 );
				float2 temp_cast_6 = (_GrassAntiTiling.x).xx;
				float2 texCoord9_g5 = IN.ase_texcoord2.xy * temp_cast_6 + float2( 0,0 );
				float2 temp_cast_7 = (_GrassAntiTiling.y).xx;
				float2 texCoord11_g5 = IN.ase_texcoord2.xy * temp_cast_7 + float2( 0,0 );
				float2 temp_cast_8 = (_GrassAntiTiling.z).xx;
				float2 texCoord13_g5 = IN.ase_texcoord2.xy * temp_cast_8 + float2( 0,0 );
				float3 temp_cast_9 = (( ( ( tex2D( _AntiTilingTexture, texCoord9_g5 ).g + 0.0 ) * ( tex2D( _AntiTilingTexture, texCoord11_g5 ).g + 0.0 ) ) * ( tex2D( _AntiTilingTexture, texCoord13_g5 ).g + 0.0 ) )).xxx;
				float3 lerpResult21_g5 = lerp( _AntiTilingVector , temp_cast_9 , float3( 1,1,1 ));
				float3 GrassColorVariation60 = lerpResult21_g5;
				float2 temp_cast_11 = (_Grass1tile).xx;
				float2 texCoord54 = IN.ase_texcoord2.xy * temp_cast_11 + float2( 0,0 );
				float4 color92 = IsGammaSpace() ? float4(0.4138842,1,0,1) : float4(0.1428077,1,0,1);
				float3 temp_output_7_0_g9 = float3(0,1,0);
				...
				float4 lerpResult86 = lerp( ( float4( RockColorVariation157 , 0.0 ) * tex2D( _Rock, texCoord88 ) ) , ( ( float4( GrassColorVariation60 , 0.0 ) * tex2D( _Grass1, texCoord54 ) ) * color92 ) , Slope82);
				float2 temp_cast_12 = (_ArialTreeTile).xx;
				float2 texCoord103 = IN.ase_texcoord2.xy * temp_cast_12 + float2( 0,0 );
				float4 tex2DNode102 = tex2D( _ArialTreeTexture, texCoord103 );
				float4 lerpResult113 = lerp( lerpResult86 , tex2DNode102 , float4( 0,0,0,0 ));
...
/*ASEBEGIN
Version=18933
353;73;2079;820;176.3105;-272.0478;1;True;True
...
Node;AmplifyShaderEditor.Vector3Node;158;-880,-1346;Inherit;False;Property;_RockAntiTiling;Rock Anti Tiling;18;0;Create;True;0;0;0;False;0;False;0,0,0;0.0001,0.001,0.01;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;81;128,-896;Inherit;False;Slope;-1;;9;55485e5d40c5f8f41983cb93729de4e0;0;3;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;796.6895,814.0478;Inherit;False;Property;_Smoothness;Smoothness;19;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;51;-793.9999,44.1;Inherit;True;Property;_Grass1;Grass 1;5;0;Create;True;0;0;0;False;0;False;-1;7b4b44557efd3ef4190530e2e45001bf;177193e849739fd4791760a7faf7d8ad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;160;4;171;0
ASEEND*/
//CHKSM=795B0486143A0AF58ADFDF67341C1B9D7A16D478